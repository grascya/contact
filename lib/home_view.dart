                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    leading: const CircleAvatar(
                      radius: 25,
                      backgroundImage: AssetImage('person_1.png'),
                    ),
                    title: const Text(
                      'Etornam Bright',
                      style:
